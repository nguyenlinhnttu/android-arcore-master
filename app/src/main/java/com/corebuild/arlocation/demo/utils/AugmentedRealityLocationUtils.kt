...
object AugmentedRealityLocationUtils {
    ...
    fun getScaleModifierBasedOnRealDistance(distance: Int): Float {
        return when (distance) {
            ...
            in 2001..2500 -> 0.35f
            in 2501..3000 -> 0.3f
            in 3001..RENDER_MARKER_MAX_DISTANCE -> 0.30f
            in RENDER_MARKER_MAX_DISTANCE + 1..Integer.MAX_VALUE -> 0.30f
            else -> -1f
        }
    }
    ...
    fun generateRandomHeightBasedOnDistance(distance: Int): Float {
        return when (distance) {
            ...
            in 3001..RENDER_MARKER_MAX_DISTANCE -> (10..12).random().toFloat()
            else -> 0f
        }
    }
